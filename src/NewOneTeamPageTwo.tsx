...
export default function OptimizedMedicalPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200">
      ...
      <div className="w-full" style={{height: '44px', background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 50%, #cbd5e1 100%)'}}></div>
      {/* Hero Section */}
      <section 
        ref={heroRef} 
        className="relative bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 pt-20 sm:pt-24 lg:pt-14 pb-16 sm:pb-20 lg:pb-24 min-h-screen flex items-center overflow-hidden"
      >
        {/* Background decorative elements */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200" />
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-gray-300/30 to-gray-400/20 rounded-full blur-3xl" />
          <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-gray-400/25 to-gray-500/15 rounded-full blur-3xl" />
          <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-gradient-to-br from-gray-300/20 to-gray-400/10 rounded-full blur-2xl" />
        </div>
          ...
          <div ref={heroContentRef} className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="flex justify-center lg:justify-end order-1 lg:order-2">
              <div className="relative group">
                ...
                <div className="w-80 sm:w-80 lg:w-[28rem] h-80 sm:h-80 lg:h-[28rem] border-2 border-[#d4af37]/50 rounded-lg shadow-lg transition-all duration-300 group-hover:border-[#d4af37]/70 group-hover:shadow-xl group-hover:shadow-[#d4af37]/20 bg-gradient-to-br from-gray-100/80 via-gray-200/60 to-gray-300/40">
                  ...
                  <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-lg">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <div className="w-1/2 h-1/2 rounded-full bg-gradient-to-br from-gray-200/30 via-gray-300/40 to-gray-400/25 blur-2xl animate-bg-pulse" />
                    </div>
                    
                    {/* Glisten spots */}
                    <div className="absolute inset-0 pointer-events-none overflow-hidden">
                      <div className="absolute w-20 h-20 left-[-10%] top-[80%] bg-gradient-radial from-gray-400/60 via-gray-300/40 to-gray-200/0 rounded-full blur-xl opacity-50 animate-glisten-spot2" />
                      <div className="absolute w-24 h-24 left-0 top-[50%] bg-gradient-radial from-gray-500/50 via-gray-400/30 to-gray-300/0 rounded-full blur-xl opacity-60 animate-glisten-spot3" />
                    </div>
            ...
            <div className="space-y-8 lg:space-y-6 text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="space-y-2 sm:space-y-4">
                ...
                <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-gray-800 via-gray-600 to-gray-700 bg-clip-text text-transparent leading-snug">
                  Your <span className="text-[#daa520] font-bold">Complete Healthcare</span> Destination
                </h2>
                <p className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 pt-0">
                <a
                  ...
                  className="flex items-center justify-center space-x-3 bg-gradient-to-r from-gray-100 to-gray-200 px-8 py-3 rounded-xl border-2 border-[#daa520] text-[#b8860b] text-base hover:text-[#daa520] hover:border-[#ffd700] hover:shadow-xl hover:shadow-[#ffd700]/30 focus:outline-none focus:ring-4 focus:ring-[#daa520]/50 transition-all duration-300 transform-gpu hover:-translate-y-1 shadow-lg shadow-[#ffd700]/20"
      ...
      <section
        ...
        className="relative bg-gradient-to-br from-gray-100 via-gray-150 to-gray-200 pt-8 pb-6 sm:pt-10 sm:pb-8 md:pt-12 md:pb-10 overflow-hidden border-t-2 border-[#d4af37]/20"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`text-center mb-5 sm:mb-14 transition-all duration-400 ease-out transform ${doctorsCardsVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-20 scale-95'}`}>
            ...
            <p className="text-xl sm:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed transition-all duration-200 mb-8">
          ...
          >
            ...
            <div className="mt-12 max-w-2xl mx-auto text-center px-4 sm:px-0">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-500 mb-8 max-w-xl mx-auto leading-relaxed font-medium">
      ...
      <section className="py-6 xs:py-10 sm:py-12 md:py-14 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-150 relative overflow-hidden">
        
        {/* Dynamic Background Layers */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-150"></div>
        
        {/* Enhanced Floating Elements with Dynamic Animations */}
        <div className={`absolute top-16 left-12 w-4 h-4 bg-gradient-to-br from-gray-400/60 to-gray-500/50 rounded-full transition-all duration-[2500ms] delay-200 ${doctorsCardsVisible ? 'opacity-100 animate-ping scale-110' : 'opacity-0 scale-0'}`}></div>
        ...
        <div className={`absolute bottom-24 left-16 w-5 h-5 bg-gradient-to-br from-gray-500/50 to-gray-600/40 rounded-full transition-all duration-[2700ms] delay-600 ${doctorsCardsVisible ? 'opacity-100 animate-pulse scale-105' : 'opacity-0 scale-0'}`}></div>
        <div className={`absolute top-1/2 left-1/4 w-2 h-2 bg-gradient-to-br from-gray-400/80 to-gray-500/70 rounded-full transition-all duration-[2100ms] delay-800 ${doctorsCardsVisible ? 'opacity-100 animate-spin' : 'opacity-0 scale-0'}`}></div>
        <div className={`absolute top-1/3 right-1/3 w-3 h-3 bg-gradient-to-br from-gray-300/40 to-gray-400/30 rounded-full transition-all duration-[2400ms] delay-1000 ${doctorsCardsVisible ? 'opacity-100 animate-pulse' : 'opacity-0 scale-0'}`}></div>
        <div className={`absolute bottom-1/3 right-12 w-4 h-4 bg-gradient-to-br from-gray-400/60 to-gray-500/50 rounded-full transition-all duration-[2600ms] delay-1200 ${doctorsCardsVisible ? 'opacity-100 animate-ping' : 'opacity-0 scale-0'}`}></div>
        <div className={`absolute top-20 left-1/2 w-2 h-2 bg-gradient-to-br from-gray-300/70 to-gray-400/60 rounded-full transition-all duration-[2200ms] delay-1400 ${doctorsCardsVisible ? 'opacity-100 animate-bounce' : 'opacity-0 scale-0'}`}></div>
        <div className={`absolute bottom-16 right-1/4 w-3 h-3 bg-gradient-to-br from-gray-500/50 to-gray-600/40 rounded-full transition-all duration-[2800ms] delay-1600 ${doctorsCardsVisible ? 'opacity-100 animate-pulse' : 'opacity-0 scale-0'}`}></div>
        
        {/* Dynamic Light Rays with Staggered Reveal */}
        <div className={`absolute top-0 left-1/5 w-0.5 h-32 bg-gradient-to-b from-gray-400/40 to-transparent transition-all duration-[3000ms] delay-300 ${doctorsCardsVisible ? 'opacity-100 scale-y-100' : 'opacity-0 scale-y-0'}`}></div>
        <div className={`absolute top-0 right-1/4 w-0.5 h-24 bg-gradient-to-b from-gray-500/35 to-transparent transition-all duration-[3200ms] delay-600 ${doctorsCardsVisible ? 'opacity-100 scale-y-100' : 'opacity-0 scale-y-0'}`}></div>
        <div className={`absolute bottom-0 left-1/3 w-0.5 h-28 bg-gradient-to-t from-gray-400/30 to-transparent transition-all duration-[3400ms] delay-900 ${doctorsCardsVisible ? 'opacity-100 scale-y-100' : 'opacity-0 scale-y-0'}`}></div>
        <div className={`absolute top-0 right-1/6 w-0.5 h-20 bg-gradient-to-b from-gray-500/45 to-transparent transition-all duration-[3100ms] delay-1100 ${doctorsCardsVisible ? 'opacity-100 scale-y-100' : 'opacity-0 scale-y-0'}`}></div>
      </section>

      {/* Enhanced Doctors Cards Section */}
      <section ref={doctorsCardsRef} className="py-8 xs:py-10 sm:py-14 md:py-16 bg-gradient-to-br from-gray-100 via-gray-150 to-gray-200 relative overflow-hidden">
        {/* Subtle Grid Pattern */}
        <div className="absolute inset-0 opacity-[0.02] bg-[url('data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23000000\' fill-opacity=\'0.3\'%3E%3Ccircle cx=\'30\' cy=\'30\' r=\'1\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 xs:px-4 sm:px-6 lg:px-8">
          ...
          <div className={`text-center mb-6 mt-0 sm:mt-1`}>
            ...
            <p className={`text-xl sm:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed transition-all duration-200 ${doctorsCardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 mb-10 sm:mb-16 md:mb-20 transition-all duration-300">
            {[
              ...
              return (
                ...
                >
                  <div className="relative bg-gradient-to-br from-gray-100/95 to-gray-200/90 group-hover:from-amber-50/95 group-hover:to-yellow-50/90 transition-all duration-700 p-8 rounded-3xl shadow-xl border border-gray-300 group-hover:border-amber-300 group-hover:shadow-2xl group-hover:shadow-amber-400/25 group-hover:-translate-y-4 group-hover:scale-[1.02] h-full overflow-hidden backdrop-blur-sm">
                    {/* Glow Overlay */}
                    <div className="absolute inset-0 bg-gradient-to-br from-gray-400/8 via-gray-500/5 to-gray-400/8 group-hover:from-amber-400/12 group-hover:via-yellow-400/18 group-hover:to-amber-400/12 transition-all duration-700 rounded-3xl"></div>
                    {/* Corners */}
                    <div className="absolute top-0 left-0 w-16 h-16 bg-gradient-to-br from-gray-400/15 to-transparent group-hover:from-amber-400/25 transition-all duration-500 rounded-3xl"></div>
                    <div className="absolute bottom-0 right-0 w-12 h-12 bg-gradient-to-tl from-gray-500/12 to-transparent group-hover:from-yellow-400/22 transition-all duration-500 rounded-3xl"></div>
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center h-full">
                      ...
                      {/* Floating Dots */}
                      <div className="absolute -top-3 -right-3 w-4 h-4 bg-gradient-to-br from-gray-400/30 to-gray-500/25 group-hover:bg-amber-500/80 rounded-full transition-all duration-500 group-hover:animate-pulse"></div>
                      <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-gradient-to-br from-gray-500/25 to-gray-600/20 group-hover:bg-yellow-500/70 rounded-full transition-all duration-700 group-hover:animate-bounce"></div>
                    </div>
                
                    {/* Animated Border Lines */}
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-gray-400/25 to-transparent group-hover:via-amber-500/70 transition-all duration-700 rounded-t-3xl"></div>
                    <div className="absolute bottom-0 right-0 w-full h-1 bg-gradient-to-l from-transparent via-gray-500/20 to-transparent group-hover:via-yellow-500/70 transition-all duration-700 rounded-b-3xl"></div>
                    <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-transparent via-gray-400/20 to-transparent group-hover:via-amber-500/50 transition-all duration-700 rounded-l-3xl"></div>
                    <div className="absolute top-0 right-0 w-1 h-full bg-gradient-to-b from-transparent via-gray-500/15 to-transparent group-hover:via-yellow-500/50 transition-all duration-700 rounded-r-3xl"></div>
                  </div>
                </div>
              );
            })}
